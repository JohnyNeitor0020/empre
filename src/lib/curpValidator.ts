/**
 * Valida el formato de un CURP mexicano con validación robusta
 * Formato completo con validación de:
 * - Primeras 4 letras (segunda debe ser vocal)
 * - Fecha válida (AAMMDD)
 * - Género (H/M)
 * - Código de estado válido
