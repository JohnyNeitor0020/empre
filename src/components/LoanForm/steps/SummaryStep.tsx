    ...
    <div className="space-y-8">
      ...
      <div className="p-6 rounded-lg bg-gradient-card border border-border shadow-md space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-base font-medium text-foreground">{data.client.nombre_completo}</p>
          </div>
      ...
      <div className="p-6 rounded-lg bg-gradient-card border border-border shadow-md space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p className="text-sm text-muted-foreground">Nombre</p>
            <p className="text-base font-medium text-foreground">{data.guarantor.nombre_completo}</p>
          </div>
      ...
      <div className="p-6 rounded-lg bg-gradient-primary border border-primary shadow-lg space-y-4">
        <div className="flex items-center gap-2 pb-2 border-b border-primary-light">
          <DollarSign className="h-5 w-5 text-primary-black" />
          <h3 className="text-lg font-semibold text-primary-black">Datos del Préstamo</h3>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p className="text-sm text-primary-black/80">Monto Solicitado</p>
          ...
          <div>
            <p className="text-sm text-primary-black/80">Total a Pagar</p>
            <p className="text-xl font-bold text-green-600">
          ...
          <div>
            <p className="text-sm text-primary-black/80">Plazo</p>
          ...
          <div>
            <p className="text-sm text-primary-black/80">Pago {data.loanDetails.paymentFrequency === 'biweekly' ? 'Quincenal' : 'Mensual'}</p>
            <p className="text-xl font-bold text-green-600">
      ...
      <div className="p-6 rounded-lg bg-gradient-card border border-border shadow-md">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-base font-medium text-black">{data.promoter.nombre_completo}</p>
          </div>

          <div>
            <p className="text-sm text-muted-foreground">Ruta</p>
            <p className="text-base font-medium text-black">{data.promoter.route}</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 rounded-lg bg-warning/10 border-2 border-warning shadow-lg space-y-6">
        ...
        <div className="flex items-center gap-2 p-4 bg-warning/5 rounded-lg border border-warning/20">
          ...
          <p className="text-xs text-muted-foreground">
            Los tokens son necesarios para validar y enviar la solicitud. Sin ambos tokens no será posible procesar el préstamo.
          </p>
        </div>
      </div>
    </div>
