    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          />
          {errors?.cp && (
            <p className="text-xs text-destructive">{errors.cp}</p>
          )}
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => onChange({ numero_ext: e.target.value })}
            placeholder="123"
          />
          {errors?.numero_ext && (
            <p className="text-xs text-destructive">{errors.numero_ext}</p>
          )}
        </div>
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) => onChange({ numero_int: e.target.value })}
            placeholder="4B"
          />
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Input
          id="crossStreets"
          value={data.cruces}
          onChange={(e) => onChange({ cruces: e.target.value })}
      ...
      {title === "Domicilio" && (
        <>
          <div className="space-y-2">
            ...
            <Select
              value={data.tiempo}
              onValueChange={(value) => onChange({ tipo: value as AddressData['tipo'] })}
            >
              <SelectTrigger>
          ...
          <div className="space-y-2">
            <Label htmlFor="timeAtAddress">
              Tiempo Viviendo en el Domicilio en Meses (solo el número)<span className="text-destructive">*</span>
            </Label>
            <Input
              id="timeAtAddress"
              value={data.tiempo}
              onChange={(e) => onChange({ tiempo: e.target.value })}
              placeholder="12 mesess"
            />
